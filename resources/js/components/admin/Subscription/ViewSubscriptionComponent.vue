        ...
        <div slot="header" class="clearfix">
          <div class="search-input-suffix" style="width: 100%">
            <el-col :span="24">
              ...
              <el-button type="success" size="mini" @click="handleAdd()" style="float:right"><i class="el-icon-plus"></i> New Subscription Product</el-button>
            </el-col>
          </div>
        </div>
...
export default {
  name: "ViewSubscriptionComponent",
  data() {
    return {
      loading: false,
      search: '',
