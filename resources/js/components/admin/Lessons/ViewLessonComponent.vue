      ...
      <el-card class="box-card layout-card">
        <div slot="header" class="clearfix">
          <div class="search-input-suffix" style="width: 100%">
            <el-col :span="24">
              <span class="search-input-label">List of Lessons</span>
              <el-button type="success" size="mini" @click="handleAdd()" style="float:right"><i class="el-icon-plus"></i> New Lesson</el-button>
            </el-col>
          </div>
        </div>
...
//   import EditComponent from './Form/EditComponent.vue'
  import CreateLessonComponent from "./CreateLessonComponent.vue";
...
//   },
  ...
  methods: {
    handleAdd() {
        this.$router.push('/lesson-management/create-lesson');
