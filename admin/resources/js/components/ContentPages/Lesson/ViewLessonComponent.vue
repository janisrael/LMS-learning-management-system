            ...
            <el-card class="box-card layout-card" shadow="never">
                <div slot="header" class="clearfix" style="text-align: center;">
                    <div class="search-input-suffix" style="width: 100%">
                        <el-col :span="24">
                            <el-input placeholder="Search Lesson" class="input-with-select search-input" clearable v-model="search" style="max-width: 600px;">
                                ...
                                <el-col v-for="(lesson, i) in this_lessons" :key="i" :xs="24" :sm="8" :md="8" :lg="6" :xl="6">
                                  <!-- {{ lesson }} -->
                                    <div class="course-card course-add-card md-card md-card-chart md-theme-default" @click="manageCourse(lesson)">
                                        ...
                                        <div :style="{'background-image': 'url(' + lesson.attachment_absolute_path + ')'}" class="md-card-header animated md-card-header-blue" data-header-animation="true">
                               
                                        </div>
                                        <div class="course-item-actions" data-header-animation="true">
                                            <el-col :span="8" class="course-item-action-icon">
                                                <i class="fas fa-edit" @click="handleEdit(lesson, i)"></i>
                                            </el-col>
                                            <el-col :span="8" class="course-item-action-icon">
                                                <i class="el-icon-s-grid" @click="manageCourse(lesson, i)" style="font-size: 16px !important;"></i>
                                            </el-col>
                                            <el-col :span="8" class="course-item-action-icon">
                                                <i class="fas fa-trash-alt" @click="handleDelete(lesson, i)"></i>
                                            </el-col>
                                        </div>
